...
import { formulaForColumnOfFour, formulaForColumnOfThree, formulaForMoveBelow, generateInvalidMoves } from "../../utils/formulas"
...
export const dragEndReducer = (
    ...
    if(
        squareBeingReplacedId && validMove && (isARowOfThree || isARowOfFour || isAColumnOfThree || isAColumnOfFour)) {
